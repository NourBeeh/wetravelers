    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        ...
        <String, dynamic>{
          ...
          'reviewCount': 214,
          'badge': 'Top pick',
          'imageUrl': 'assets/images/placeholder_hotel.png',
    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'price': 450,
          'currency': 'USD',
          'imageUrl': 'assets/images/placeholder_deal.png',
        },
        <String, dynamic>{
          'id': 'p1',
          'type': 'package',
        ...
        <String, dynamic>{
          ...
          'price': 78,
          'currency': 'USD',
          'imageUrl': 'assets/images/placeholder_car.png',
          'actions': <Map<String, dynamic>>[
    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'type': 'destination',
          'title': 'Santorini',
          'imageUrl': 'assets/images/placeholder_destination.png',
        },
        <String, dynamic>{
          'id': 'dst2',
          'type': 'destination',
