    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        ...
        <String, dynamic>{
          ...
          'reviewCount': 214,
          'badge': 'Top pick',
          'imageUrl': 'https://loremflickr.com/400/300/marina,hotel',
        ...
        <String, dynamic>{
          ...
          'reviewCount': 189,
          'badge': 'Popular',
          'imageUrl': 'https://loremflickr.com/400/300/bay,hotel',
          'order': 1,
          'data': <String, dynamic>{'city': 'Paris'},
        },
        <String, dynamic>{
          ...
          'rating': 4.2,
          'reviewCount': 97,
          'imageUrl': 'https://loremflickr.com/400/300/city,skyline',
          'order': 2,
          'data': <String, dynamic>{'city': 'Paris'},
        },
      ],
    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'price': 450,
          'currency': 'USD',
          'imageUrl': 'https://loremflickr.com/400/300/travel,airplane',
        },
        <String, dynamic>{
          'id': 'p1',
          'type': 'package',
          ...
          'currency': 'USD',
          'badge': 'Best value',
          'imageUrl': 'https://loremflickr.com/400/300/paris,eiffel',
        },
        <String, dynamic>{
          'id': 'c1',
          'type': 'car',
          ...
          'price': 78,
          'currency': 'USD',
          'imageUrl': 'https://loremflickr.com/400/300/suv,car',
          'actions': <Map<String, dynamic>>[
    ...
    <String, dynamic>{
      ...
      'items': <Map<String, dynamic>>[
        <String, dynamic>{
          ...
          'type': 'destination',
          'title': 'Santorini',
          'imageUrl': 'https://loremflickr.com/400/300/santorini,greece',
        },
        <String, dynamic>{
          'id': 'dst2',
          'type': 'destination',
          'title': 'Kyoto',
          'imageUrl': 'https://loremflickr.com/400/300/kyoto,temple,japan',
        },
        <String, dynamic>{
          'id': 'dst3',
          'type': 'destination',
          'title': 'Reykjavík',
          'imageUrl': 'https://loremflickr.com/400/300/reykjavik,iceland',
        },
      ],
    },
  ],
