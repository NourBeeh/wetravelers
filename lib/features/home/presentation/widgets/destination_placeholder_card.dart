...
/// Destination placeholder card for Home horizontal carousels.
///
/// Vertical, image-first card. Image is the dominant visual element.
/// Bottom gradient overlay with destination name and country placeholders.
...
class DestinationPlaceholderCard extends StatelessWidget {
  const DestinationPlaceholderCard({
    super.key,
    required this.item,
    this.onTap,
  });
